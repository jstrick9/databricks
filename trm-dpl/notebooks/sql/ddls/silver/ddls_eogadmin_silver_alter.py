...
config_file_name = "eogadmin-conf.yaml"
...
#spark.conf.set('conf.catalog', eogadmin_catalog.lower()) 
...
for column, comment in column_comments.items():
  ...
  COMMENT '{comment}'
  """.format(catalog=eogadmin_catalog, database=database, table='job_control', column_name=column, comment=comment)
...
for column, comment in column_comments.items():
  ...
  ALTER COLUMN {column_name}
  COMMENT '{comment}'
  """.format(catalog=eogadmin_catalog, database=database, table='job_log', column_name=column, comment=comment)
