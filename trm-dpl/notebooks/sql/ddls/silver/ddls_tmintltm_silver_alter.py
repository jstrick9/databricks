...
print(f'{trgt_catalog=}, {data_quality_catalog=} ')

#spark.conf.set('config.data_quality_catalog', data_quality_catalog.lower())
#spark.conf.set('conf.catalog', trgt_catalog.lower()) 
...
for column, comment in column_comments.items():
  ...
  COMMENT '{comment}'
  """.format(catalog=trgt_catalog, database=database, table='job_control', column_name=column, comment=comment)
...
for column, comment in column_comments.items():
  ...
  ALTER COLUMN {column_name}
  COMMENT '{comment}'
  """.format(catalog=trgt_catalog, database=database, table='job_log', column_name=column, comment=comment)
