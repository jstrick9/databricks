...
for column, comment in column_comments.items():
  ...
  COMMENT '{comment}'
  """.format(catalog=tmngfpepp_catalog, database=database, table='job_control', column_name=column, comment=comment)
...
for column, comment in column_comments.items():
  ...
  ALTER COLUMN {column_name}
  COMMENT '{comment}'
  """.format(catalog=tmngfpepp_catalog, database=database, table='job_log', column_name=column, comment=comment)
