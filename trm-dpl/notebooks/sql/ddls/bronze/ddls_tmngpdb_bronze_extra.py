...
# MAGIC   POTENTIEL_ABANDONMENT_DT	DATE,
# MAGIC   SOU_RECEIVED_DT	DATE,
...
# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE ${conf.catalog}.${conf.database}.prcdng_employee_assignment (
...
# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE ${conf.catalog}.${conf.database}.prcdng_employee_assignment_h (
# MAGIC cfk_proceeding_gid            string,
# MAGIC fk_prcdng_employee_role_cd    string,
# MAGIC cfk_employee_no               string,
# MAGIC effective_dt                  timestamp,
...
# MAGIC trm_tram_sync_control_id  int,
# MAGIC insert_ts                 timestamp,
