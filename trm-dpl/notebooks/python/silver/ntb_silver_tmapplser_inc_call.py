...
job_name = 'ntb_silver_tmapplser_inc_call'
...
def run_notebook(date, env):
    ...
    dbutils.notebook.run("./ntb_silver_tmapplser_inc_load", 0, {"rundate": date.strftime("%Y-%m-%d"), "dbx_env": env, "SRC_SYS_NAME" : "TMNGPDB"})
