...
job_name = 'ntb_silver_tmapplser_inc_call_hstry'
...
def run_notebook(date, env):
    ...
    dbutils.notebook.run("./ntb_silver_tmapplser_inc_load_based_on_hstry_tables", 0, {"rundate": date.strftime("%Y-%m-%d"), "dbx_env": env, "SRC_SYS_NAME" : "TMNGPDB"})
