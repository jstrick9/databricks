...
dbutils.widgets.text("data_load_group", "", "data_load_group")
...
if SRC_SYS_NAME == 'TMNGPDB':
    ...
    schema_metadata = f"{SRC_SYS_NAME.lower()}_metadata_" + data_load_group
else:
...
def process_table(job_control):
    ...
    try:
        ...
        if (
            ...
            df_src_cdc = read_data_from_oracle_conn_dsu_cmn(
            ...
            if max_LAST_MOD_TS != "1900-01-01":
                ...
                df_src_full_pk = read_data_from_oracle_conn_dsu_cmn(
            ...
            df_src_count = read_data_from_oracle_conn_dsu_cmn(
...
results = {}   # will map table_name -> (success: bool, message: str)
